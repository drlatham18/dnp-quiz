...
const qs=window.QUIZ_DATA.flatMap(t=>t.questions);assert.equal(qs.length,64);assert.equal(window.CASE_DATA.length,0);
...
console.log('Public library: 64 source-linked questions; clinical drafts excluded');
